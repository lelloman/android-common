...
internal class SemanticTimeProviderImpl(
    ...
    override fun getDateTimeString(time: Long): String = dateTimeFormat.format(time)

    override fun getTimeQuantity(ms: Long): String {
    ...
    override fun getTimeDiffString(timeUtcMs: Long): String {
